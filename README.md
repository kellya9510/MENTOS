...
Using <img src="https://latex.codecogs.com/svg.latex?\text{Generator}_{\text{Llama2}}" />
...
Using <img src="https://latex.codecogs.com/svg.latex?\text{Generator}_{\text{Qwen3}}" />
| Model                                                                               |   **B-4**  |  **MET**  | **Dist-3** |   **C_W**  |   **C_S**  | **Greedy** |  **B-4**  |   **MET**  | **Dist-3** |   **C_W**  |   **C_S**  | **Greedy** |
| :---------------------------------------------------------------------------------- | :--------: | :-------: | :--------: | :--------: | :--------: | :--------: | :-------: | :--------: | :--------: | :--------: | :--------: | :--------: |
|                                                                                     | **ESConv** |           |            |            |            |            | **ExTES** |            |            |            |            |            |
...
Using <img src="https://latex.codecogs.com/svg.latex?\text{Generator}_{\text{Llama3.2}}" />
| Model                                                                               |   **B-4**  |  **MET**  | **Dist-3** |   **C_W**  |   **C_S**  | **Greedy** |  **B-4**  |   **MET**  | **Dist-3** |   **C_W**  |   **C_S**  | **Greedy** |
| :---------------------------------------------------------------------------------- | :--------: | :-------: | :--------: | :--------: | :--------: | :--------: | :-------: | :--------: | :--------: | :--------: | :--------: | :--------: |
|                                                                                     | **ESConv** |           |            |            |            |            | **ExTES** |            |            |            |            |            |
